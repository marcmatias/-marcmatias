<template>
  <div class="author">
    ...
    <h1 v-if="showTitle" class="author__site-title">@marcmatias</h1>
    ...
    <p class="author__site-description">
      ...
      <a target="blank" href="//brasil.io">Brasilio</a>.
      <a target="blank" href="//twitter.com/search?q=%23python"> #Python</a
      >&nbsp;
      <a target="blank" href="//twitter.com/search?q=%23javascript"
        >#Javascript</a
      >&nbsp;
      <a target="blank" href="//twitter.com/search?q=%23freesoftware"
        >#Freesoftware</a
      >&nbsp;
      <a target="blank" href="//twitter.com/search?q=%23opensource"
        >#Opensource</a
      >&nbsp;
    </p>

    <p class="author__links">
      <a arget="_blank" href="//codepen.io/marcmatias" title="Codepen">
      ...
      <a arget="_blank" href="//github.com/marcmatias" title="GitHub">
        <svg viewBox="0 0 512 512" width="40">
          <path
      ...
      <a arget="_blank" href="//twitter.com/marcmatias" title="Twitter">
        <svg viewBox="0 0 512 512" width="40">
          <path
